...
from app.core.analysis.analysis import _count_statuses_for_cols
...
# @router.post(
#     "/trigger-upsert_session_screening_counts", description="Run Phase 1 Analysis"
# )
# async def trigger_analysis_pipeline(session_id_value: str, session: AsyncSession = Depends(deps.get_session), current_user: User = Depends(deps.get_current_user)):
#     """
#     API endpoint to submit trigger for screening analysis
...
#     """
#     try:
#         # 1) Fetch ENS rows for this session
...
#             session_status_cols,
#             session_id_value,
#             session,  # pass the AsyncSession you already have
#         )

#         # 5) ✅ Make response JSON-safe WITHOUT touching your upsert function
#         if isinstance(trigger_response, dict) and "data" in trigger_response:
#             rows = trigger_response.get("data") or []
