    ...
    try:
        ...
        for event in leg_data:  # TODO Sort this by date descending and take get the first 5
            ...
            text = f"""
                    ...
                    \n
                """
            current_unique_detail = f"{event.get('eventCategory')}: {event.get('eventCategoryDesc')} - {truncate_string(event.get('eventDesc'))} (Date: {event_date})\n"
        ...
        LEG1A["kpi_data"] = unique_data_points
