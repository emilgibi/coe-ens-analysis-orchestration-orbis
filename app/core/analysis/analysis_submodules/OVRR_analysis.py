...
async def ovrr(data, session):
    ...
    try:
        ...
        entity = await get_dynamic_ens_data("entity_existence", required_columns, ens_id_value, session_id_value, session)
        entity_high_trigger = False
        entity_medium_trigger = False
        entity_low_trigger = False
        logger.info(f'---> sape findings: {entity}')
        for row in entity:
            if row.get("kpi_flag"):
                if "High" in row.get('kpi_rating'):
                    logger.debug("high")
                    entity_high_trigger = True
                    break
                elif "Medium" in row.get('kpi_rating'):
                    logger.debug("medium")
                    entity_medium_trigger = True
                elif "Low" in row.get('kpi_rating'):
                    logger.debug("low")
                    entity_low_trigger = True
        entity_rating = "High" if entity_high_trigger else "Medium" if entity_medium_trigger else "Low" if entity_low_trigger else "No Alerts"
        logger.info(
            f'\tentity_rating = {entity_rating} \n\tentity_high_trigger = {entity_high_trigger} \n\tentity_medium_trigger = {entity_medium_trigger} \n\tentity_high_trigger = {entity_low_trigger}')
        ...
        logger.info(f'---> sape findings: {sape}')
        for row in sape:
            if row.get("kpi_flag"):
                if "High" in row.get('kpi_rating'):
                    logger.debug("high")
        ...
        logger.info(f'\tsanction_rating = {sanctions_rating} \n\tsape_high_trigger = {sape_high_trigger} \n\tsape_medium_trigger = {sape_medium_trigger} \n\tsape_high_trigger = {sape_low_trigger}')
        ...
        logger.info(f'---> esg findings: {esg}')
        for row in esg:
            if "High" in row.get('kpi_rating'):
        ...
        logger.info(
            f'\tesg_rating = {esg_rating} \n\tesg_medium_trigger = {esg_medium_trigger} \n\tesg_low_trigger = {esg_low_trigger}')
        ...
        logger.info(f'---> cyb findings: {cyb}')
        for row in cyb:
            if "High" in row.get('kpi_rating'):
        ...
        logger.info(
            f'\tcyber_rating = {cyb_rating} \n\t medium_trigger = {cyb_medium_trigger} \n\t low_trigger = {cyb_low_trigger}')
        ...
        logger.info(f'---> web findings: {web}')
        for row in web:
            if row.get("kpi_flag"):
                if "High" in row.get('kpi_rating'):
        ...
        logger.info(
            f'\tweb_rating = {web_rating} \n\t high_trigger = {web_high_trigger} \n\t medium_trigger = {web_medium_trigger}')
        ...
        logger.info(f'compile_section_rating - {compile_section_ratings}')
        ...
        logger.info(
            f'\tadditional_rating = {additional_indicator_rating}')
        ...
        logger.info(
            f'\tfin_rating = {fin_rating} \n\t high_trigger = {fin_high_trigger} \n\t medium_trigger = {fin_medium_trigger} \n\t low_trigger = {fin_low_trigger}')
        ...
        logger.info(f'---> amo_amr_onf findings: {amo_amr_onf_2cents}')
        ...
        logger.info(
            f'\tam_rating = {am_rating} \n\t high_trigger = {am_high_trigger} \n\t medium_trigger = {am_medium_trigger} \n\t low_trigger = {am_low_trigger}')
        ...
        logger.info(f'---> bcf findings: {bcf}')
        for row in bcf:
            if row.get("kpi_flag"):
                if "High" in row.get('kpi_rating'):
        ...
        logger.info(
            f'\tbcf_rating = {bcf_rating} \n\t high_trigger = {bcf_high_trigger} \n\t medium_trigger = {bcf_medium_trigger} \n\t low_trigger = {bcf_low_trigger}')
        ...
        logger.info(f'---> sown findings: {sown}')
        for row in sown:
            if row.get("kpi_flag"):
                if "High" in row.get('kpi_rating'):
        ...
        logger.info(
            f'\tgov_rating = {gov_rating} \n\t high_trigger = {gov_high_trigger} \n\t medium_trigger = {gov_medium_trigger} \n\t low_trigger = {gov_low_trigger}')
        ...
        # logger.info(
        #     f'\townership_rating = {ownership_rating} \n\t high_trigger = {oval_high_trigger} \n\t medium_trigger = {oval_medium_trigger} \n\t low_trigger = {oval_low_trigger}')
        ...
        ovr_kpis = [government_political_overall, bribery_corruption_overall, regulatory_legal_overall,
                      other_adverse_media_overall, financials_overall, additional_indicator_overall,esg_overall,
                    cyber_overall, sanctions_overall, ownership_overall, entity_overall]

        compile_section_ratings = [d.get("kpi_rating","") for d in ovr_kpis]
        logger.info(f'---> compile section(overall): {compile_section_ratings}')
        ...
        logger.info(
            f'\toverall_rating = {supplier_rating}')
