...
async def sanctions_analysis(data, session):
    ...
    try:
        ...
        if len(sanctions_data) > 0:
            ...
            unique_data_points_direct = []  # For SAN1A
            unique_data_points_indirect = []  # For SAN2A
            ...
            for record in sanctions_data:
                ...
                if event_category in indirect_eventCategory:
                    ...
                    current_unique_detail = f"{date_string} {sanction_entity_name} {event_categoryDesc} - {event_subcategoryDesc}: \n {sanction_details}"
            ...
            if SAN1A["kpi_flag"]:
                ...
                details = "Following sanctions imposed :\n"
                ...
                SAN1A["kpi_details"] = details
                SAN1A["kpi_data"] = unique_data_points_direct
            else:
                SAN1A["kpi_value"] = ""
            ...
            if SAN2A["kpi_flag"]:
                ...
                SAN2A["kpi_details"] = details
                SAN2A["kpi_data"] = unique_data_points_indirect
            else:
                SAN2A["kpi_value"] = ""
        ...
        if not person_info_none and len(person_retrieved_data) > 0:
            ...
            unique_data_points_direct = []  # For SAN1B
            unique_data_points_indirect = []  # For SAN2B
            ...
            for record in all_person_san_events:
                ...
                if event_category in indirect_eventCategory:
                    ...
                    if (record.get("resignation_date") is not None) and (record.get("resignation_date")!= 'n.a'):
                        ...
                        tenure=''
                    current_unique_detail = f"{date_string} {sanction_entity_name} ({current_or_previous} Key Executive - {job_title}{tenure}) {event_categoryDesc} - {event_subcategoryDesc}: \n {sanction_details}"
                    unique_data_points_indirect.append(current_unique_detail)
            ...
            if SAN1B["kpi_flag"]:
                ...
                SAN1B["kpi_details"] = details
                SAN1B["kpi_data"] = unique_data_points_direct
            else:
                SAN1B["kpi_value"] = ""
            ...
            if SAN2B["kpi_flag"]:
                ...
                SAN2B["kpi_details"] = details
                SAN2B["kpi_data"] = unique_data_points_indirect
            else:
                SAN2B["kpi_value"] = ""
